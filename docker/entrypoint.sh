...
window.VUE_APP_CUSTOM_LOGO_URL='${WIS2BOX_UI_LOGO}'
window.VUE_APP_CUSTOM_BACKGROUND_COLOR='${WIS2BOX_UI_BACKGROUND_COLOR}'
window.VUE_APP_DISABLE_SEPARATOR_IMAGE=('${WIS2BOX_UI_DISABLE_SEPARATOR_IMAGE}' === 'true' || '${WIS2BOX_UI_DISABLE_SEPARATOR_IMAGE}' === 'True')"
